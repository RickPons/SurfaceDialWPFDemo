...
namespace SurfaceDialExample.Extensions
{
    ...
    {
        Stream internstream; public RandomStream(Stream underlyingstream) { internstream = underlyingstream; }
        ...
        public bool CanRead
        {
            get
            {
                return this.internstream.CanRead;
            }
        }
        public bool CanWrite
        {
            get
            {
                return this.internstream.CanWrite;
            }
        }
        ...
        public ulong Position { get { return (ulong)this.internstream.Position; } }
